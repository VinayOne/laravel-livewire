...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $title ?? 'User Signup and Login Demo' }}</title>
    ...
    <body>
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    @guest
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('register')) ? 'active' : '' }}" href="/register" wire:navigate>Sign Up</a>
                        </li>
                    @else    
        ...
        <div class="container">
            <h3 class="mt-3 mb-5 text-center">User Signup and Login Demo</h3>
